# Generated by Django 4.2.11 on 2024-05-08 01:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conn_partnumber', models.TextField(default='', verbose_name='conn_partnumber')),
                ('conn_wires', models.TextField(default='', verbose_name='conn_wires')),
                ('conn_port_name', models.TextField(default='', verbose_name='conn_port_name')),
                ('conn_manu', models.TextField(default='', verbose_name='conn_manu')),
                ('conn_cage_code', models.TextField(default='', verbose_name='conn_cage_code')),
                ('conn_lru_refdes', models.TextField(default='', verbose_name='conn_lru_refdes')),
                ...
                ('conn_insert_arrangement', models.TextField(default='', verbose_name='conn_insert_arrangement')),
                ('conn_contact_type', models.TextField(default='', verbose_name='conn_contact_type')),
                ('conn_keying', models.TextField(default='', verbose_name='conn_keying')),
                ('conn_contact_size', models.TextField(default='', verbose_name='conn_contact_size')),
                ('conn_hermetical_sealing', models.TextField(default='', verbose_name='conn_hermetical_sealing')),
                ...
                ('conn_user_comment', models.TextField(default='', verbose_name='conn_user_comment')),
                ('conn_photo_file_path', models.TextField(default='', verbose_name='conn_photo_file_path')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lru_software_rev', models.TextField(default='', verbose_name='lru_software_rev')),
                ('lru_user_comment', models.TextField(default='', verbose_name='lru_user_comment')),
                ('lru_photo_file_path', models.TextField(default='', verbose_name='lru_photo_file_path')),
            ],
        ),
        migrations.CreateModel(
            name='port',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wire_part_number', models.TextField(default='', verbose_name='wire_part_number')),
                ('wire_name', models.TextField(default='', verbose_name='wire_name')),
                ('termination_refdes', models.TextField(default='', verbose_name='wire_term_refdes')),
                ...
                ('conductor_contact_size', models.TextField(default='', verbose_name='wire_cond_cont_size')),
                ...
                ('conductor_signal_type', models.TextField(default='', verbose_name='wire_signal_type')),
                ...
                ('conductor_resistance', models.TextField(default='', verbose_name='wire_resistance')),
                ('shielding', models.TextField(default='', verbose_name='wire_shielding')),
                ('weight', models.TextField(default='', verbose_name='wire_weight')),
                ('conductor_diameter', models.TextField(default='', verbose_name='wire_diameter')),
                ('conductor_material', models.TextField(default='', verbose_name='wire_material')),
                ('conductor_jacket', models.TextField(default='', verbose_name='wire_jacket')),
                ('conductor_voltage_rating', models.TextField(default='', verbose_name='wire_voltage_rating')),
                ('conductor_temperature_rating', models.TextField(default='', verbose_name='wire_temp_rating')),
                ('length', models.TextField(default='', verbose_name='wire_length')),
                ('user_comment', models.TextField(default='', verbose_name='wire_comment')),
                ('photo_file_path', models.TextField(default='', verbose_name='wire_photo_filepath')),
                ('harness_refdes', models.TextField(default='', verbose_name='wire_harness_refdes')),
                ('harness_part_number', models.TextField(default='', verbose_name='wire_harness_pn')),
            ],
        ),
    ]
